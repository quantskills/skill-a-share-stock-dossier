...
```text
You have access to a local skill named a-share-stock-dossier at:
<A_SHARE_STOCK_DOSSIER_SKILL_ROOT>

When the user request matches this skill's SKILL.md description:
1. Read <A_SHARE_STOCK_DOSSIER_SKILL_ROOT>/SKILL.md.
2. Follow the workflow and guardrails in that file exactly.
3. Load referenced files under <A_SHARE_STOCK_DOSSIER_SKILL_ROOT>/references/ only when needed.
